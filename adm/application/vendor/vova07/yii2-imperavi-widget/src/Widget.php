...
class Widget extends BaseWidget
{
    ...
    public function init()
    {
        ...
        $this->settings = [
            'lang' => 'ru',
            'minHeight' => 200,
            'imageUpload' => Url::to(['/edit/tools/file-upload']),
            'imageDelete' => Url::to(['/edit/tools/file-delete']),
            'imageManagerJson' => Url::to(['/edit/tools/images-get']),
            'fileUpload' => Url::to(['/edit/tools/file-upload']),
            'fileDelete' => Url::to(['/edit/tools/file-delete']),
            'fileManagerJson' => Url::to(['/edit/tools/files-get']),
            'plugins' => [
                'fullscreen',
            ],
        ];
